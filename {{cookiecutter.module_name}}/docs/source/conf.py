...
htmlhelp_basename = 'Bio2BEL{{ cookiecutter.module_stylized }}doc'
...
texinfo_documents = [
    (master_doc, 'Bio2BEL{{ cookiecutter.module_stylized }}', 'Bio2BEL {{ cookiecutter.module_stylized }} Documentation',
     author, 'Bio2BEL{{ cookiecutter.module_stylized }}', 'One line description of project.',
     'Miscellaneous'),
]
